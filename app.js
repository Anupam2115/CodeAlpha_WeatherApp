...
const weatherApi = {
    ...
    key: '97391c33d1127c9a80b123527e375325',
...
function showWeatherReport(weather) {
    ...
    if(city_code==='400'){ 
        swab("Empty Input", "Please enter any city", "error");
        reset();
    }else if(city_code==='404'){
        swab("Bad Input", "entered city didn't matched", "warning");
        reset();
    }
    else{
...
function getIconClass(classer) {
    if (classer === 'Rain') {
        return 'fas fa-cloud-showers-heavy';
    } else if (classer === 'Clouds') {
        return 'fas fa-cloud';
    } else if (classer === 'Clear') {
        return 'fas fa-cloud-sun';
    } else if (classer === 'Snow') {
        return 'fas fa-snowman';
    } else if (classer === 'Sunny') {
        return 'fas fa-sun';
    } else if (classer === 'Mist') {
        return 'fas fa-smog';
    } else if (classer === 'Thunderstorm' || classer === 'Drizzle') {
